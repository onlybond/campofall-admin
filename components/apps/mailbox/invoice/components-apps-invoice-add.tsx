                ...
                <div className="mt-8 px-4">
                    <div className="flex flex-col justify-between lg:flex-row">
                        <div className="mb-6 w-full lg:w-1/2 ltr:lg:mr-6 rtl:lg:ml-6">
                            <div className="text-lg">Edit Resources </div>
                            <div className="mt-4 flex items-center">
                            ...
                            <div className="mt-4">
                                ...
                                <select id="Resource-type" name="Resource-type" className="form-select">
                                    <option value=" ">Select Resource type</option>
                                    <option value="Ai-Websites">Ai Websites</option>
                                    <option value="Figma-plugins">Figma plugins</option>
                                    <option value="designer-assets">designer assets</option>
                                </select>
                            </div>
                            <div className="mt-4 flex items-center">
